...
@Entity
@Table(name="matriculas", indexes={@Index(name="matriculasAlumno", columnList="alumno,curso")})
public class Matriculas implements Serializable {
    ...
    /**
     * Compares the key for this instance with another Matriculas.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class Matriculas and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof Matriculas)) {
            return false;
        }
        Matriculas that = (Matriculas) other;
    ...
    /**
     * Compares this instance with another Matriculas.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof Matriculas)) return false;
        return this.equalKeys(other) && ((Matriculas)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[Matriculas |");
